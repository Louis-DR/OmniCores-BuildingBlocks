...
| `write_empty`                  | output    | 1              | `write_clock` | `write_resetn` | `1`         | Queue empty status in write domain.<br/>`0`: queue contains data.<br/>`1`: queue is empty.                                                   |
| `write_almost_empty`           | output    | 1              | `write_clock` | `write_resetn` | `1`         | Queue almost empty status in write domain.<br/>`0`: queue is empty or has more than one entry.<br/>`1`: queue has exactly one entry.         |
| `write_half_empty`             | output    | 1              | `write_clock` | `write_resetn` | `1`         | Queue half empty status in write domain.<br/>`0`: queue half full.<br/>`1`: queue half empty.                                                |
| `write_not_empty`              | output    | 1              | `write_clock` | `write_resetn` | `0`         | Queue not empty status in write domain.<br/>`0`: queue is empty.<br/>`1`: queue contains data.                                               |
| `write_not_full`               | output    | 1              | `write_clock` | `write_resetn` | `1`         | Queue not full status in write domain.<br/>`0`: queue is full.<br/>`1`: queue has free space.                                                |
| `write_half_full`              | output    | 1              | `write_clock` | `write_resetn` | `0`         | Queue half full status in write domain.<br/>`0`: queue half empty.<br/>`1`: queue half full.                                                 |
| `write_almost_full`            | output    | 1              | `write_clock` | `write_resetn` | `0`         | Queue almost full status in write domain.<br/>`0`: queue is full or has more than one free space.<br/>`1`: queue has exactly one free space. |
| `write_full`                   | output    | 1              | `write_clock` | `write_resetn` | `0`         | Queue full status in write domain.<br/>`0`: queue has free space.<br/>`1`: queue is full.                                                    |
...
| `read_empty`                   | output    | 1              | `read_clock`  | `read_resetn`  | `1`         | Queue empty status in read domain.<br/>`0`: queue contains data.<br/>`1`: queue is empty.                                                    |
| `read_almost_empty`            | output    | 1              | `read_clock`  | `read_resetn`  | `1`         | Queue almost empty status in read domain.<br/>`0`: queue is empty or has more than one entry.<br/>`1`: queue has exactly one entry.          |
| `read_half_empty`              | output    | 1              | `read_clock`  | `read_resetn`  | `1`         | Queue half empty status in read domain.<br/>`0`: queue half full.<br/>`1`: queue half empty.                                                 |
| `read_not_empty`               | output    | 1              | `read_clock`  | `read_resetn`  | `0`         | Queue not empty status in read domain.<br/>`0`: queue is empty.<br/>`1`: queue contains data.                                                |
| `read_not_full`                | output    | 1              | `read_clock`  | `read_resetn`  | `1`         | Queue not full status in read domain.<br/>`0`: queue is full.<br/>`1`: queue has free space.                                                 |
| `read_half_full`               | output    | 1              | `read_clock`  | `read_resetn`  | `0`         | Queue half full status in read domain.<br/>`0`: queue half empty.<br/>`1`: queue half full.                                                  |
| `read_almost_full`             | output    | 1              | `read_clock`  | `read_resetn`  | `0`         | Queue almost full status in read domain.<br/>`0`: queue is full or has more than one free space.<br/>`1`: queue has exactly one free space.  |
| `read_full`                    | output    | 1              | `read_clock`  | `read_resetn`  | `0`         | Queue full status in read domain.<br/>`0`: queue has free space.<br/>`1`: queue is full.                                                     |

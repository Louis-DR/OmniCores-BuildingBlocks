...
# ║ License:     MIT License                                                  ║
# ║ File:        asynchronous_fifo_controller.sdc                             ║
# ╟───────────────────────────────────────────────────────────────────────────╢
# ║ Description: SDC constraints for the asynchronous FIFO controller module. ║
# ║                                                                           ║
# ╚═══════════════════════════════════════════════════════════════════════════╝
...
namespace eval ::omnicores::buildingblocks::timing::asynchronous_fifo_controller {

  # Apply timing constraints to a specific instance of the asynchronous FIFO controller module

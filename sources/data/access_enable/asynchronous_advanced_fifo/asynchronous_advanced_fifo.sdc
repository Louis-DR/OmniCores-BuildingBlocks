...
# ║ License:     MIT License                                                  ║
# ║ File:        asynchronous_advanced_fifo.sdc                               ║
# ╟───────────────────────────────────────────────────────────────────────────╢
# ║ Description: SDC constraints for the asynchronous advanced FIFO module.   ║
# ║                                                                           ║
# ╚═══════════════════════════════════════════════════════════════════════════╝
...
namespace eval ::omnicores::buildingblocks::timing::asynchronous_advanced_fifo {

  # Apply timing constraints to a specific instance of the asynchronous advanced FIFO module

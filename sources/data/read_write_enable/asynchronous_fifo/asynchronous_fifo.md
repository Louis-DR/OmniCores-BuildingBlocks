...
| Module                                                                                      | Path                                                                                 | Comment                                                             |
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [`valid_ready_asynchronous_fifo`](../../valid_ready/asynchronous_fifo/asynchronous_fifo.md) | `omnicores-buildingblocks/sources/data/valid_ready/asynchronous_fifo`                | Variant of this module with valid-ready handshake flow control.     |

...
# ║ License:     MIT License                                                  ║
# ║ File:        valid_ready_asynchronous_fifo.sdc                            ║
# ╟───────────────────────────────────────────────────────────────────────────╢
# ║ Description: SDC constraints for the valid-ready asynchronous FIFO        ║
# ║              module.                                                      ║
# ║                                                                           ║
# ╚═══════════════════════════════════════════════════════════════════════════╝
...
namespace eval ::omnicores::buildingblocks::timing::valid_ready_asynchronous_fifo {

  # Apply timing constraints to a specific instance of the valid-ready asynchronous FIFO module

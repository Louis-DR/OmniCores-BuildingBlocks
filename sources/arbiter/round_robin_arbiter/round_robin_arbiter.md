...
| Symbol shape      | [`round_robin_arbiter.symbol.drawio`](round_robin_arbiter.symbol.drawio)   | Generated DrawIO shape of the symbol.               |
...
| [`fast_first_one`](../../operations/fast_first_one/fast_first_one.md)                                | `omnicores-buildingblocks/sources/operations/fast_first_one`             | For the `fast` and `balanced` variants. |
...
| [`shift_left`](../../operations/shift_left/shift_left.md)                                            | `omnicores-buildingblocks/sources/operations/shift_left`                 | For the `fast` and `balanced` variants. |

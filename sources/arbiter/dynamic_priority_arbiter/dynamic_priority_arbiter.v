...
generate
  for (genvar request_index = 0; request_index < SIZE; request_index++) begin : gen_unpack_priorities
...
generate
  for (genvar request_index = 0; request_index < SIZE; request_index++) begin : gen_priorities_onehot
    binary_to_onehot #(
...
generate
  for (genvar priority_index = 0; priority_index < PRIORITY_WIDTH_POW2; priority_index++) begin : requests_per_priority_class_1
    for (genvar request_index = 0; request_index < SIZE; request_index++) begin : requests_per_priority_class_2
...
generate
  for (genvar request_index = 0; request_index < SIZE; request_index++) begin : priority_class_per_requests_1
    for (genvar priority_index = 0; priority_index < PRIORITY_WIDTH_POW2; priority_index++) begin : priority_class_per_requests_2
...
generate
  for (genvar priority_class_index = 0; priority_class_index < PRIORITY_WIDTH_POW2; priority_class_index++) begin : gen_active_priority_classes
...
generate
  for (genvar priority_class_index = 1; priority_class_index < PRIORITY_WIDTH_POW2; priority_class_index++) begin : gen_highest_priority_classes
...
generate
  for (genvar request_index = 0; request_index < PRIORITY_WIDTH_POW2; request_index++) begin : gen_highest_priority_requests

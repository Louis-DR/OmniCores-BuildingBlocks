...
// ║ License:     MIT License                                                  ║
// ║ File:        galois_lfsr.testbench.sv                                     ║
// ╟───────────────────────────────────────────────────────────────────────────╢
// ║ Description: Testbench for the Galois linear feedback shift register.     ║
// ║                                                                           ║
// ╚═══════════════════════════════════════════════════════════════════════════╝
...
initial begin
  // Log waves
  $dumpfile("galois_lfsr.testbench.vcd");
  $dumpvars(0,galois_lfsr__testbench);
  $timeformat(-9, 0, " ns", 0);

...
The `rotate_right` module is verified using a SystemVerilog testbench. A top-level testbench, `rotate_right.tb.sv`, instantiates the testcase module, `rotate_right.tc.sv`, once for each parameter set configured.

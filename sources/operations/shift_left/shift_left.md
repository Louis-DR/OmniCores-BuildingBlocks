...
The `shift_left` module is verified using a SystemVerilog testbench. A top-level testbench, `shift_left.tb.sv`, instantiates the testcase module, `shift_left.tc.sv`, once for each parameter set configured.
...
| Symbol descriptor  | [`shift_left.sss`](shift_left.sss)           | Symbol descriptor for SiliconSuite-SymbolGenerator. |
| Symbol image       | [`shift_left.svg`](shift_left.svg)           | Generated vector image of the symbol.               |

...
| --------------------------------------------- | -------------- | ----------------------------------------------------------------- | ------------------------------------------------------------- |
| `static_priority_arbiter`                     | arbiter        | Static priority arbiter                                           | :green_circle:  :green_circle:  :green_circle: :white_circle: |
| `dynamic_priority_arbiter`                    | arbiter        | Dynamic priority arbiter                                          | :green_circle:  :red_circle:    :red_circle:   :white_circle: |
| `round_robin_arbiter`                         | arbiter        | Round-robin arbiter                                               | :green_circle:  :green_circle:  :red_circle:   :white_circle: |

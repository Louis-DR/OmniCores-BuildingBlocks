...
| `binary_to_bcd`                                                                                                                           | encoding       | Binary to Binary-Coded Decimal encoder                                            | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `bcd_to_binary`                                                                                                                           | encoding       | Binary-Coded Decimal to binary decoder                                            | :green_circle:  :green_circle:  :red_circle:   :white_circle: |

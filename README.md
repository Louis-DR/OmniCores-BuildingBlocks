...
| [`wide_clock_multiplexer`](sources/clock/wide_clock_multiplexer/wide_clock_multiplexer.md)                                                | clock          | Glitch-free wide clock multiplexer                                                | :green_circle:  :green_circle:  :green_circle: :red_circle:   |
...
| [`reorder_buffer`](sources/data/read_write_enable/reorder_buffer/reorder_buffer.md)                                                       | data           | Buffer with out-of-order write and in-order read access                           | :green_circle:  :orange_circle: :green_circle: :white_circle: |

...
| [`switchover_clock_selector`](sources/clock/switchover_clock_selector/switchover_clock_selector.md)                     | clock          | Glitch-free clock switch-over from a first clock to a second clock when it starts | :green_circle:  :green_circle:  :green_circle: :red_circle:   |
| [`priority_clock_selector`](sources/clock/priority_clock_selector/priority_clock_selector.md)                           | clock          | Glitch-free clock switch to a fallback clock if the primary is not running        | :green_circle:  :green_circle:  :green_circle: :red_circle:   |
...
| `reorder_buffer`                                                                                                        | data           | Buffer with out-of-order write and in-order read access                           | :green_circle:  :orange_circle: :red_circle:   :white_circle: |
...
| `parity_encoder`                                                                                                        | error control  | Parity encoder                                                                    | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `parity_checker`                                                                                                        | error control  | Parity checker                                                                    | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `parity_block_checker`                                                                                                  | error control  | Parity checker with block input                                                   | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `repetition_encoder`                                                                                                    | error control  | Repetition encoder                                                                | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `repetition_checker`                                                                                                    | error control  | Repetition checker                                                                | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `repetition_corrector`                                                                                                  | error control  | Repetition corrector                                                              | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `repetition_block_checker`                                                                                              | error control  | Repetition checker with block input                                               | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `repetition_block_corrector`                                                                                            | error control  | Repetition corrector with block input                                             | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_encoder`                                                                                                       | error control  | Hamming encoder                                                                   | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_checker`                                                                                                       | error control  | Hamming checker                                                                   | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_corrector`                                                                                                     | error control  | Hamming corrector                                                                 | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_block_checker`                                                                                                 | error control  | Hamming checker with block input                                                  | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_block_corrector`                                                                                               | error control  | Hamming corrector with block input                                                | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_block_packer`                                                                                                  | error control  | Hamming block packer                                                              | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `hamming_block_unpacker`                                                                                                | error control  | Hamming block unpacker                                                            | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_encoder`                                                                                              | error control  | Extended Hamming encoder                                                          | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_checker`                                                                                              | error control  | Extended Hamming checker                                                          | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_corrector`                                                                                            | error control  | Extended Hamming corrector                                                        | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_block_checker`                                                                                        | error control  | Extended Hamming checker with block input                                         | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_block_corrector`                                                                                      | error control  | Extended Hamming corrector with block input                                       | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_block_packer`                                                                                         | error control  | Extended Hamming block packer                                                     | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `extended_hamming_block_unpacker`                                                                                       | error control  | Extended Hamming block unpacker                                                   | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
...
| `edge_detector`                                                                                                         | pulse          | Edge detector                                                                     | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `rising_edge_detector`                                                                                                  | pulse          | Rising edge detector                                                              | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `falling_edge_detector`                                                                                                 | pulse          | Falling edge detector                                                             | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `multi_edge_detector`                                                                                                   | pulse          | Rising and falling edge detector                                                  | :green_circle:  :green_circle:  :red_circle:   :white_circle: |

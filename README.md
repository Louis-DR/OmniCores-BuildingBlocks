...
| `single_port_ram`                                                                                                                         | memory         | Single-port RAM                                                                   | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `simple_dual_port_ram`                                                                                                                    | memory         | Simple Dual-port RAM                                                              | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `asynchronous_simple_dual_port_ram`                                                                                                       | memory         | Asynchronous simple dual-port RAM                                                 | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `true_dual_port_ram`                                                                                                                      | memory         | True Dual-port RAM                                                                | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `asynchronous_true_dual_port_ram`                                                                                                         | memory         | Asynchronous true dual-port RAM                                                   | :green_circle:  :green_circle:  :red_circle:   :white_circle: |

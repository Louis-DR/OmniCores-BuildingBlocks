...
| `out_of_order_buffer`                                                                                 | data           | Buffer with out-of-order read access                              | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
...
| `valid_ready_out_of_order_buffer`                                                                     | data           | Buffer with out-of-order read access and valid-ready flow control | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
...
| [`rotator_left`](sources/operations/rotator_left/rotator_left.md)                                     | operations     | Rotate a vector left with wrapping by a static amount             | :green_circle:  :green_circle:  :green_circle: :white_circle: |
| [`rotator_right`](sources/operations/rotator_right/rotator_right.md)                                  | operations     | Rotate a vector right with wrapping by a static amount            | :green_circle:  :green_circle:  :green_circle: :white_circle: |
| [`shifter_left`](sources/operations/shifter_left/shifter_left.md)                                     | operations     | Shift a vector left with padding by a static amount               | :green_circle:  :green_circle:  :green_circle: :white_circle: |
| [`shifter_right`](sources/operations/shifter_right/shifter_right.md)                                  | operations     | Shift a vector right with padding by a static amount              | :green_circle:  :green_circle:  :green_circle: :white_circle: |
...
| `small_first_one`                                                                                     | operations     | Determine the position of the first one (small variant)           | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `fast_first_one`                                                                                      | operations     | Determine the position of the first one (fast variant)            | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `first_one`                                                                                           | operations     | Determine the position of the first one (variant wrapper)         | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
...
| `synchronizer`                                                                                        | timing         | Simple synchronizer                                               | :green_circle:  :green_circle:  :red_circle:   :green_circle: |
| `fast_synchronizer`                                                                                   | timing         | Fast synchronizer                                                 | :green_circle:  :green_circle:  :red_circle:   :green_circle: |

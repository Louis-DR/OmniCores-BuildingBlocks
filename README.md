...
| `clock_switchover`                                                                                                      | clock          | Glitch-free clock switch-over from a first clock to a second clock when it starts | :green_circle:  :green_circle:  :red_circle:   :red_circle:   |
| [`clock_fallback`](sources/clock/clock_fallback/clock_fallback.md)                                                      | clock          | Glitch-free clock switch to a fallback clock if the primary is not running        | :green_circle:  :green_circle:  :green_circle: :red_circle:   |

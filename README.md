...
| `small_first_one`                             | operations     | Determine the position of the first one (small)                | :green_circle:  :green_circle:  :red_circle: :white_circle: |
| `fast_first_one`                              | operations     | Determine the position of the first one (fast)                 | :green_circle:  :green_circle:  :red_circle: :white_circle: |

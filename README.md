...
| [`switchover_clock_selector`](sources/clock/switchover_clock_selector/switchover_clock_selector.md)                     | clock          | Glitch-free clock switch-over from a first clock to a second clock when it starts | :green_circle:  :green_circle:  :red_circle:   :red_circle:   |

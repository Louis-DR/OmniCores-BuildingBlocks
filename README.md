...
| `binary_to_onehot`                                                                                                         | encoding       | Binary to one-hot encoder                                                         | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `onehot_to_binary`                                                                                                         | encoding       | One-hot to binary decoder                                                         | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `binary_to_grey`                                                                                                           | encoding       | Binary to Grey encoder                                                            | :green_circle:  :green_circle:  :red_circle:   :white_circle: |
| `grey_to_binary`                                                                                                           | encoding       | Grey to binary decoder                                                            | :green_circle:  :green_circle:  :red_circle:   :white_circle: |

...
| `advanced_fifo_controller`                                                                                                                | data           | Synchronous FIFO queue controller with additional features                        | :green_circle:  :white_circle:  :red_circle:   :white_circle: |
| `asynchronous_fifo_controller`                                                                                                            | data, timing   | Asynchronous FIFO queue controller                                                | :green_circle:  :white_circle:  :red_circle:   :red_circle:   |
| `asynchronous_advanced_fifo_controller`                                                                                                   | data, timing   | Asynchronous FIFO queue controller with additional features                       | :green_circle:  :white_circle:  :red_circle:   :red_circle:   |
| `lifo_controller`                                                                                                                         | data           | Synchronous LIFO stack controller                                                 | :green_circle:  :white_circle:  :red_circle:   :white_circle: |
| `out_of_order_buffer_controller`                                                                                                          | data           | Buffer controller with in-order write and out-of-order read access                | :green_circle:  :white_circle:  :red_circle:   :white_circle: |
| `reorder_buffer_controller`                                                                                                               | data           | Buffer controller with out-of-order write and in-order read access                | :green_circle:  :white_circle:  :red_circle:   :white_circle: |
